...
ui <- 
    dashboardPage(skin = "green",
            ...
            other than conventional fuels. Common alternative fuels include Compressed Natural Gas, Electric, Hydrogen, and Liquefied Natural Gas. 
                                         This application will help you to find nearest stations, cost of refueling, and even analysis on alternative fuel stations."),
          ...
          need to get to their destinations."),
                                      infoBox("Calculators", 2, icon = icon("calculator"),fill = TRUE, width = "auto")
                                  ),
                                  box(
                                      width=6,
                          ...
                          tabItem(
                              ...
                              navbarPage(
                                  ...
                                  tabPanel(
                                      ...
                                      fluidRow(
                                          box(
                                              h4("Average price"), height = 370,
                                              plotOutput(outputId = "fuel_table1", width = "50%", height="200px")),
                                          box(
                                              h4("Average price by EEF"), height = 370,
                          ...
                          tabItem(
                              ...
                              fluidRow(
                                  ...
                                  box(
                                      ...
                                      h4("Rui Cao - rc3208@columbia.edu"),
                                      h4("Suzy Gao - zg2333@columbia.edu"),
                                      h4("Evelyn - ym2775@tc.columbia.edu"),
                                      h4("Yuting - yg2641@columbia.edu")
                                  )
                              )
                          )
                      )
...
server <- function(input, output) {
    ...
    output$top_city <- renderPlotly({
        top10_city <-anal_data %>%
            group_by(City) %>%
            summarise(count=n())%>%
            arrange(desc(count))%>%
            head(n=10)
        
        top10_city$City = as.character(top10_city$City)
        top10_city$City <- factor(top10_city$City, levels = top10_city[['City']])
        top10_city %>%
